...
public class CatalogTest {
    ...
    @Test
    public void getInventory_sizeShouldBeThirty() {
        assertEquals(30, Catalog.getInventory().size());
    }

    @Test
    public void findByBrands_shouldReturnMap_brandsPassed() {
    ...
    public void findByBrand_shouldReturnEmptyCollection_brandNotFound() {
        ...
        // assertNotNull(tvs); dont have to say this because test will fail anyway
